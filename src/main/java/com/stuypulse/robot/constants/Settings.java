...
public interface Settings {
    ...
    public interface EnabledSubsystems {
        SmartBoolean SUPERSTRUCTURE = new SmartBoolean("Enabled Subsystems/Superstructure", false);
        SmartBoolean SWERVE = new SmartBoolean("Enabled Subsystems/Swerve Is Enabled", true);
    }

    public interface Superstructure {

        double SHOOTER_INTAKE_SHOOT = -1;
        double SHOOTER_INTAKE_OUTTAKE = -1;
        double SHOOTER_INTAKE_INTAKE = 1;
