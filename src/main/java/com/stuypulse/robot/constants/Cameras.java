...
public interface Cameras {
    ...
    public Camera[] LimelightCameras = new Camera[] {
            ...
            new Camera("limelight-turret",
                    new Pose3d(Units.inchesToMeters(6.5), Units.inchesToMeters(-11.308), Units.inchesToMeters(7.910),
                            new Rotation3d(Units.degreesToRadians(180), Units.degreesToRadians(35.6),
                                    Units.degreesToRadians(0))),
                    Settings.EnabledSubsystems.LIMELIGHT_TURRET)
    };
