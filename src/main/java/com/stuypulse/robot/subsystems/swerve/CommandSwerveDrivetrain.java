...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public double[] getRadiusCharacterizationModulePositions(){
        ...
        for(int i = 0; i < 4; i++){
            positions[i] = getModule(i).getDriveMotor().getPosition().getValueAsDouble() * 2 * Math.PI / 6.12;
        }
        return positions;
    }
    ...
    public void periodic() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            SmartDashboard.putNumber("Swerve/Module " + i + "/Rotations", getModule(i).getDriveMotor().getPosition().getValueAsDouble());
        }
