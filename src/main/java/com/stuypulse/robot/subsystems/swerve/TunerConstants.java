...
/************************ REGENERATE THE CONSTANTS! **************************/
/* This file currently exists so that the swerve subsystem can compile.      */
/* Make sure to regenerate the constants as soon as the drivetrain is wired. */
/*****************************************************************************/
...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(31.311).withKI(0.0).withKD(0.84368)
        .withKS(0.17708).withKV(1.4591).withKA(0.026645)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.23046).withKI(0.0).withKD(0.0)
        .withKS(0.13806).withKV(0.21423).withKA(0.18032);
    ...
    public static final CANBus kCANBus = Settings.canBus3;
